		...
		<fieldset class="fieldset_common_style">
			<table class="table_common_style">
				...
				<tr>
					...
					<td class="table_common_td_txt_style">
						2017-05-22 08:00:00.0</td>
				</tr>
				<tr>
					<td class="table_common_td_label_comment_style">投诉内容：</td>
					<td style="height: 60px;" class="table_common_td_txt_style">
						<textarea class="easyui-textbox" style="width:400px;height:60px" data-options="multiline:true" readOnly>质量问题</textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="height: 60px; width:200px;" class="table_common_td_txt_style">
						<textarea class="easyui-textbox" rows="2" style="width:400px;height:60px" data-options="multiline:true" readOnly></textarea>
					</td>
				</tr>
			</table>
		</fieldset>
